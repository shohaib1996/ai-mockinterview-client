...
const BehavioralDetailsPage = ({ id }: { id: string }) => {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6 max-w-4xl">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-bold text-balance">Behavioral Interview Details</h1>
...
export default BehavioralDetailsPage;