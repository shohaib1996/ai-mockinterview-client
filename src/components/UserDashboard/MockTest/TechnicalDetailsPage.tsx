...
import { ISinglesSession, AiChatConversation } from "@/types"

// Define interface for conversation to improve type safety
interface TechnicalDetailsPageProps {
  id: string
}

export default function TechnicalDetailsPage({ id }: TechnicalDetailsPageProps) {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6 max-w-4xl">
      ...
      <div className="space-y-2">
        <h1 className="text-3xl font-bold text-balance">Technical Interview Details</h1>
